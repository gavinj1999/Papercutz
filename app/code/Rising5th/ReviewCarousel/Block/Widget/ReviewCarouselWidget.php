...
class ReviewCarouselWidget extends Template implements BlockInterface
{
    ...
    public function __construct(
        ...
        try {
            $this->setTemplate('Rising5th_ReviewCarousel::widget/carousel.phtml');
            $this->logger->debug('Initialized ReviewCarouselWidget with template: Rising5th_ReviewCarousel::widget/carousel.phtml');
        } catch (\Exception $e) {
